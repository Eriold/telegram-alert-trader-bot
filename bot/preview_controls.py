...
def build_help_message(trading_mode: str) -> str:
    ...
    return (
        ...
        "<code>/eth15m</code> -> Estado ETH 15m (vista simple)\n"
        "<code>/eth1h</code> -> Estado ETH 1h (vista simple)\n"
        "<code>/btc15m</code> -> Estado BTC 15m (vista simple)\n"
        "<code>/btc1h</code> -> Estado BTC 1h (vista simple)\n\n"
        "<code>/{mercado}-{N}</code> -> Estado simple con ultimas N sesiones (ej: /eth15m-15)\n"
        "<code>N</code> -> 1 a 50 (si supera 50, se limita a 50)\n\n"
        "<b>Comparativo Polymarket vs Binance</b>\n"
        "<code>/pvbeth15m</code> -> Compara cierres ETH 15m (P vs B)\n"
        "<code>/pvbeth1h</code> -> Compara cierres ETH 1h (P vs B)\n"
        "<code>/pvbbtc15m</code> -> Compara cierres BTC 15m (P vs B)\n"
        "<code>/pvbbtc1h</code> -> Compara cierres BTC 1h (P vs B)\n"
        "<code>/pvb{mercado}-{N}</code> -> Comparativo con ultimas N sesiones (ej: /pvbbtc1h-20)\n\n"
        "<b>Estado detallado (integridad)</b>\n"
        "<code>/eth15mD</code> -> Estado ETH 15m con trazabilidad OPEN/CLOSE\n"
        "<code>/eth1hD</code> -> Estado ETH 1h con trazabilidad OPEN/CLOSE\n"
        "<code>/btc15mD</code> -> Estado BTC 15m con trazabilidad OPEN/CLOSE\n"
        "<code>/btc1hD</code> -> Estado BTC 1h con trazabilidad OPEN/CLOSE\n"
        "<code>/{mercado}D-{N}</code> -> Estado detallado con ultimas N sesiones (ej: /btc1hD-15)\n"
        "Sufijo <code>D</code> = Detail (muestra fuentes y alertas de integridad).\n\n"
        "<b>Ejemplos estado extendido</b>\n"
        "<code>/eth15m-15</code> -> ETH 15m simple con 15 sesiones\n"
        "<code>/btc15m-15</code> -> BTC 15m simple con 15 sesiones\n"
        "<code>/eth1h-15</code> -> ETH 1h simple con 15 sesiones\n"
        "<code>/btc1h-15</code> -> BTC 1h simple con 15 sesiones\n"
        "<code>/eth15mD-15</code> -> ETH 15m detalle con 15 sesiones\n"
        "<code>/btc15mD-15</code> -> BTC 15m detalle con 15 sesiones\n"
        "<code>/eth1hD-15</code> -> ETH 1h detalle con 15 sesiones\n"
        "<code>/btc1hD-15</code> -> BTC 1h detalle con 15 sesiones\n\n"
